...
## Analyse der Sprache (use of language)

### Wortwahl (choice of words)
- Ist ein bestimmtes **Themenwortfeld** _(field of words)_ erkennbar? _(z.B. war, love, nature, etc.)_
- Werden **Fachbegriffe** _(technical terms)_ verwendet? _(z.B. psychology, biology, etc.)_
...
- Alltagssprache _(everyday, casual English)_
...
- hypotaktische Satzstruktur _(complex sentence structures)_ (aus Haupt- und Nebensätzen bestehende Satzgebilde, oft lang)
...
- Vergleiche _(similes)_
- Personifikationen _(personifications)_
- Alliterationen _(alliterations)_
